...
export default function RegisterPage() {
  ...
  async function handleSubmit(e) {
    ...
    setLoading(true);
    try {
      const { access_token } = await api.post("/api/auth/register", form);
    ...
    <main style={{ minHeight: "100vh", background: "#020617", display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div style={{ width: "100%", maxWidth: 400, padding: "0 24px" }}>
        <div style={{ marginBottom: 32, textAlign: "center" }}>
          <h1 style={{ color: "#e5e7eb", fontSize: 28, margin: "0 0 8px 0" }}>Create account</h1>
          <p style={{ color: "#6b7280", margin: 0, fontSize: 14 }}>Start tracking your portfolio</p>
        </div>
