...
export default function IsmServicesAdminPage() {
  ...
  async function handleFetchLatest() {
    ...
    setFetchStatus(null);
    try {
      const res = await fetch("http://localhost:8000/api/ism/services/fetch-latest", { method: "POST" });
  ...
  async function handleImport() {
    ...
    try {
      const res = await fetch("http://localhost:8000/api/ism/services/load-urls", {
        method: "POST",
  ...
  return (
    <div style={{ color: "#e5e7eb", fontFamily: "Arial, sans-serif", maxWidth: 900, margin: "0 auto", padding: "28px 24px" }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 6 }}>
        <PageHeader title="ISM Services — Data Import" style={{ marginBottom: 0 }} />
      ...
      <p style={{ color: "#9ca3af", fontSize: 14, marginBottom: 24 }}>
        ...
        <code style={{ background: "var(--bg-surface)", border: "1px solid var(--border)", padding: "4px 8px", borderRadius: 6, color: "#93c5fd", display: "inline-block", marginTop: 6 }}>
          site:prnewswire.com "ism services pmi report"
        </code>
      </p>
      ...
      <textarea
        ...
        placeholder={"https://www.prnewswire.com/news-releases/services-pmi-at-54-june-2026-ism-services-pmi-report-302817275.html\nhttps://www.prnewswire.com/news-releases/..."}
        style={{
